...
RSIP continues as the long-term stable-state module. CTDP V2 Beta focuses on adjudication quality: when a boundary is disputed, the user must either accept chain breakage / reservation breach or formalize a precedent.
